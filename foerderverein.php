<?php /* Template Name:Foerderverein */ ?>

<?php include("header-foerderverein.php"); ?>
	...
	<section id="foerderverein" class="content">
		<h1>F&ouml;rderverein der Max-Beckmann-Grundschule</h1>
		...
		<div class="bb-custom-wrapper" id="bb-custom-wrapper">
					...
					<nav>
							<span class="bb-current">Vereinsmotto</span>
							<span>Vorstand</span>
...
<?php include("footer-foerderverein.php"); ?>